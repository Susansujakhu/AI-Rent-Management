                ...
                {confirmDeleteId === c.id && (
                  <div className="mt-2 rounded-lg border border-rose-200 dark:border-rose-500/30 bg-rose-50/60 dark:bg-rose-500/10 p-3 space-y-2">
                    ...
                    <p className="text-[11px] text-rose-600/90 dark:text-rose-400/90 leading-relaxed">
                      Destructive. Every past bill across all tenants in this room that included <span className="font-semibold">{c.title}</span> will be recomputed as if the charge never existed — paid totals and outstanding amounts will change. Use <span className="font-semibold">Stop</span> instead if you only want to end it from a future month.
                    </p>
